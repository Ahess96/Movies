...
You will need to create a new React project named`react-movies` based on the way we setup our mern infrastructure in class, although we won't be connecting to mongodb so there's no need to configure a database connection. 
